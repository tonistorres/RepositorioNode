...
const generatorCode = require("./q02");

const a= generatorCode();
const b=generatorCode();
const c=generatorCode();

function calcMatematico(a, b, c) {
...
calcMatematico(10, 10, 10)
  .then((resolve) => console.log(resolve))
  .catch((error) => console.log(error));

calcMatematico(1, 1, "a")
  .then((resolve) => console.log(resolve))
  .catch((error) => console.log(error));

async function executeCalcMatematicoTryCatch() {
  try {
    await calcMatematico(1, 1, 1);
  } catch (error) {
    console.log(error);
  }
}

executeCalcMatematicoTryCatch();

// calcMatematico(1, 1, 1)
// .then(resolve => console.log(resolve))
// .catch(error => console.log(error))
